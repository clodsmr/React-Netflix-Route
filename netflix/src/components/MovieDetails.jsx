...
class MovieDetails extends Component {
    ...
    fetchMovie = async () => {
        ...
        let url = `http://www.omdbapi.com/?apikey=2470e3c&i=${asin}`;
        try {
    ...
    render() {
        console.log("in the render", this.state.movies)
        return (
              ...
              <Col className="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-2 px-1 py-3">
                <div className="card-gallery card-text-area position-relative">
                 <img class="img-fluid rounded" src={this.state.movies.Poster} alt="" /> 
                  <div class="infos-container">
                    <div class="infos-content">
                      ...
                      <p>
                        <small>{this.state.movies.Title}</small>
                      </p>
                      <div class="movie-footer">
                        <span>{this.state.movies.Year}</span>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="16"
                          height="16"
